...
im0 = cv2.imread("static/Loader.jpg")
# im0 = cv2.imread("static/load_loading.gif")
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if view_img:
                ...
                if H > 900:
                    im0 = imutils.resize(im0, height=600)
                (H, W) = im0.shape[:2]
                # print("After",(H, W))
...
def parse_opt():
    ...
    parser.add_argument('--view-img',default='', action='store_true', help='show results')
